...
commands=(
    ...
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.1 --shotfive --patternstrict --widthtree 1" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.1 --shotfive --patternstrict --widthtree 4" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.1 --shotfive --patternstrict --widthtree 6" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.1 --shotfive --patternstrict --widthtree 8" 
