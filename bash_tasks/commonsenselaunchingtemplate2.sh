...
commands=(
    ...
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa,sports,date --shotfive --spr 0.4" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa,sports,date --check --kernel_size 16 --spr 0.4 --thr 0.05 --shotfive --patternstrict --widthtree 1" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks strategyqa,sports,date --shotfive --spr 0.4" 
    "accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks strategyqa,sports,date --check --kernel_size 16 --spr 0.4 --thr 0.05 --shotfive --widthtree 1" 
