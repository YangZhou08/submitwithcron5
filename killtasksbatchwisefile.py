...
if checkpoint_path == "y": 
    ...
    queryf = open("killtasksbatchwise.txt", "r") 
else: 
    exit(0) 
jobidsbringing = [] 
...
file = open("./bash_tasks/killtasks_timehash{}.sh".format(hash_of_time), "w")
...
for jobid in jobidsbringing: 
    ...
    commands += "/opt/slurm/bin/scancel {}\n".format(jobid) 
...
print("The bash script has been written to ./bash_tasks/killtasks_timehash{}.sh".format(hash_of_time)) 
