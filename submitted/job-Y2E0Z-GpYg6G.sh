...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks csqa,sports,date --check --kernel_size 16 --spr 0.4 --thr 0.1 --shotfive --widthtree 6 --model meta-llama/Llama-2-13b-hf 
