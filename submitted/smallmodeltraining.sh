...
# accelerate launch --main_process_port 29506 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --batch_size 128 --experiment_setting setting0 --use_mse_loss --lr 2e-4 --use_pretrained_small_model --finetuned_small_model_checkpoint YangZhoumill/llama_160m_deciphering_tinyllama_setting0_01da4cb_hf --resume_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/largemodeltinyllama_e006960_602427/checkpoint-3000 
...
accelerate launch --main_process_port 29503 --num_processes 8 --num_machines 1 weird_training_ddpstep.py --experiment_setting setting0 --kernel_size 7 --model_name tinyllama 
