...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_largeplussmall.py --experiment_setting setting3 --kernel_size 2 --model_name tinyllama --batch_size 24 --use_large_model --autoregressive_first_element --group1lr 1.5e-5 --usedatasettype c4 --num_epoch 5 --finetune_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting3_2_ff438f8_670600/checkpoint-1000/ --resume_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting3_2_8722cf9_584599/checkpoint-1400/ --wandb_session fje8js4f --wandb_session_name tinyllama_kernelsize2_batchsize12k --fullcoverage --path_d 1 --datafilegranularity 48 --gradient_accumulation_steps 64 --warmup_steps 1000 
