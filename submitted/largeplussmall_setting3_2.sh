...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_largeplussmalllora.py --experiment_setting setting3 --kernel_size 2 --model_name tinyllama --batch_size 32 --use_large_model --autoregressive_first_element --group1lr 5e-5 --usedatasettype c4 --num_epoch 5 --finetune_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting3_2_ff438f8_670600/checkpoint-1000/ --fullcoverage --path_d 0 --datafilegranularity 24 --gradient_accumulation_steps 16 --warmup_steps 1000 
