...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks aqua --check --kernel_size 16 --spr 0.5 --thr 0.2 --shotfive --patternstrict --widthtree 1 --model meta-llama/Llama-2-13b-chat-hf 
