...
cd /fsx-storygen/beidic/yang/transformersprofiling/datasets_evaluation 
CUDA_VISIBLE_DEVICES=0 /data/home/beidic/anaconda3/envs/yangllm2/bin/python Evaluation_Language_modeling_3.py --model_name debugging --experiment_setting setting3 --kernel_size 7 --dataset_name c4llm_synthesized --loading_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/largemodeltinyllama_5afc329_643929/checkpoint-3300 
