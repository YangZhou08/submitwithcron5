...
accelerate launch --main_process_port 29506 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 3 --batch_size 64 --experiment_setting setting0 --ce_loss_only --lr 2e-4 --num_epochs 10 
