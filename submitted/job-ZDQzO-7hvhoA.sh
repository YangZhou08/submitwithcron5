...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks csqa,strategyqa,sports,date --spr 0.3 --model meta-llama/Meta-Llama-3-8B 
