...
accelerate launch --main_process_port 29508 --num_processes 8 --num_machines 1 largemodelfinetuning_msepluscelosstwo.py --large_model tinyllama --kernel_size 7 --alpha 0.5 --ce_loss_only --experiment_setting setting3 --batch_size 128 --lr 2e-4 --resume_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/largemodeltinyllama_71ff182_049503/checkpoint-1500 
