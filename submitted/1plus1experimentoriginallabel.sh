...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29509 --num_processes 1 --num_machines 1 weird_training_addinglarge.py --experiment_setting setting0 --kernel_size 1 --model_name tinyllama --autoregressive_first_element --batch_size 128 
