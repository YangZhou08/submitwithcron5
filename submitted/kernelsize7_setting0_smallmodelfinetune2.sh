...
# /data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_addinglarge.py --experiment_setting setting0 --kernel_size 7 --model_name tinyllama --batch_size 16 --use_large_model --autoregressive_first_element 
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_plain.py --model_name tinyllama --batch_size 32 --usedatasettype c4 --path_d 1 --wandbsession yzhfuhyz --resume_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_2daf217_904574/checkpoint-2500 
