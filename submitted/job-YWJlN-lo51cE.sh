...
accelerate launch --num_processes 8 main.py --tasks humaneval --do_sample False --cats --check --n_samples 1 --batch_size 1 --max_length_generation 512 --enable_epatches --allow_code_execution --widthtree 1 --patternstrict --model meta-llama/Llama-2-13b-hf 
