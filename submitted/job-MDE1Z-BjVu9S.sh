...
accelerate launch --timeout 1800 --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks aqua --check --kernel_size 16 --spr 0.5 --thr 0.1 --shotfive --patternstrict --widthtree 2 --model meta-llama/Meta-Llama-3-8B-Instruct 
