...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 mainfordebugging.py --griffin --tasks aqua --shotfive --model meta-llama/Llama-2-7b-hf 
