...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --model xhf --model_args pretrained=meta-llama/Meta-Llama-3-8B,griffin=True,check=True,kernel_size=16,spr=0.5,thr=0.7 --tasks gsm8k --batch_size 1  
