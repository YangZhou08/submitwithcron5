...
lengths=(128 256 512 1024 1536 2048 3072 4096) 
for contextlength in "${lengths[@]}" 
do 
    python main.py --model xhf --model_args pretrained=meta-llama/Meta-Llama-3-8B-Instruct,griffin=False,check=False,contextlength=$contextlength --tasks gsm8k --batch_size 1 --limit 0.3 
    python main.py --model xhf --model_args pretrained=meta-llama/Meta-Llama-3-8B-Instruct,griffin=True,check=False,contextlength=$contextlength --tasks gsm8k --batch_size 1 --limit 0.3 
done 
