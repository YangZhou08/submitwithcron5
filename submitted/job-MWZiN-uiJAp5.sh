...
accelerate launch --num_processes 8 main.py --tasks humaneval --do_sample False --n_samples 1 --batch_size 1 --max_length_generation 512 --enable_epatches --allow_code_execution --model meta-llama/Llama-2-13b-chat-hf 
