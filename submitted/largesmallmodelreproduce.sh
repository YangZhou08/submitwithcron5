...
accelerate launch --main_process_port 29506 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --batch_size 128 --ce_loss_only --lr 2e-4 --experiment_setting setting3 --embedding_reinitialization_type xavieruniform 
