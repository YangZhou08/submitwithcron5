...
accelerate launch --timeout 1800 --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks csqa,strategyqa,sports,date --shotfive --spr 0.4 --model meta-llama/Llama-2-13b-chat-hf 
