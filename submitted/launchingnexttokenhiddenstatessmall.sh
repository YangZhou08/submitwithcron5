...
# /data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29508 --num_processes 8 --num_machines 1 weird_training_addinglarge.py --experiment_setting setting5 --kernel_size 7 --model_name tinyllama --use_large_model --autoregressive_first_element 
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29508 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --experiment_setting setting0 --kernel_size 7 --large_model tinyllama --alpha 0.5 --ce_loss_only --batch_size 128 --lr 2e-4 --use_new_small_model_checkpoint --finetuned_large_model_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/largemodeltinyllama_5afc329_643929/checkpoint-3300 --freeze_large_model 
