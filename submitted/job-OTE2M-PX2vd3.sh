...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks aqua --check --kernel_size 12 --spr 0.5 --thr 0.1 --shotfive --widthtree 8 --model meta-llama/Meta-Llama-3-8B 
