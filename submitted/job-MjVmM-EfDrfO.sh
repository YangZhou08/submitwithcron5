...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks csqa,strategyqa,sports,date --check --kernel_size 16 --spr 0.4 --thr 0.1 --shotfive --patternstrict --widthtree 1 --model meta-llama/Meta-Llama-3-8B-Instruct 
