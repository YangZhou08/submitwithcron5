...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29508 --num_processes 8 --num_machines 1 weird_training_plain.py --model_name tinyllama --batch_size 32 
