...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --cats --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.01 --shotfive --patternstrict --widthtree 4 --model meta-llama/Meta-Llama-3-8B 
