...
#SBATCH --output=/fsx-storygen/beidic/yang/submitwithcron/data-log/log-%j.out
## filename for job standard error output (stderr)
#SBATCH --error=/fsx-storygen/beidic/yang/submitwithcron/data-log/log-%j.err
...
accelerate launch --main_process_port 29506 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --use_pretrained_small_model --finetuned_small_model_checkpoint YangZhoumill/llama-160m_deciphering_tinyllama_setting3_bfafdfa_hf --batch_size 128 --ce_loss_only --lr 2e-4 --gradient_accumulation_steps 32 
# accelerate launch --main_process_port 29508 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --alpha 0.5 --ce_loss_only --experiment_setting setting3 --batch_size 128 --embedding_reinitialization_type xavieruniform 
