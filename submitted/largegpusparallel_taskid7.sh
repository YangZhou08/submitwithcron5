...
do 
    CUDA_VISIBLE_DEVICES=$i /data/home/beidic/anaconda3/envs/yangllm2/bin/python bigmodeldatasetgeneration_savenone.py --model_name llama2_7b --path_d $i --batch_size 32 --task_id 7 & 
done 
