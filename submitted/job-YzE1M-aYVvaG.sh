...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --tasks strategyqa,sports,date --shotfive --model meta-llama/Meta-Llama-3-8B-Instruct 
