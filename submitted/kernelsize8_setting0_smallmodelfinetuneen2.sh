...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_addingextralarge.py --experiment_setting setting0 --kernel_size 8 --model_name llama2_7b --batch_size 16 --use_large_model --resume_from_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/llama2_7b_setting0_8_69f7a68_503187/checkpoint-500/ --wandb_session zdhnjrs8 --wandb_session_name recoveringmodekernelsize8setting0 --usedatasettype math 
