...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_largeplussmall.py --experiment_setting setting0 --kernel_size 7 --model_name tinyllama --batch_size 20 --use_large_model --autoregressive_first_element --group1lr 2e-5 --usedatasettype c4 --num_epoch 5 --finetune_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting0_7_7093b04_125037/checkpoint-1000/ --fullcoverage --warmup_steps 1000 --path_d 0 
