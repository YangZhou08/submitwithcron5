...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_largeplussmall.py --experiment_setting setting0 --kernel_size 2 --model_name tinyllama --batch_size 24 --use_large_model --autoregressive_first_element --group1lr 1.5e-5 --usedatasettype c4 --num_epochs 5 --finetune_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting0_2_ff438f8_013712/checkpoint-1000/ --fullcoverage --path_d 0 --datafilegranularity 24 --gradient_accumulation_steps 16 --warmup_steps 1000 
