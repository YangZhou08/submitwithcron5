...
# done 
python main.py --model xhf --model_args pretrained=meta-llama/Meta-Llama-3-70B-Instruct,griffin=False,check=False,contextlength=1500,kernel_size=16,thr=0.05 --tasks mmlu_flan_cot_fewshot --batch_size 1 --limit 750 
