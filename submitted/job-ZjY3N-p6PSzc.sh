...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --griffin --tasks strategyqa --check --kernel_size 10 --spr 0.4 --thr 0.01 --shotfive --widthtree 4 --model meta-llama/Llama-2-7b-hf 
