...
/data/home/beidic/anaconda3/envs/hanshi/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --model xhf --model_args pretrained=lmsys/vicuna-33b-v1.3,griffin=True,check=True,griffinnotcats=False --tasks gsm8k,triviaqa,ifeval --batch_size 1 
