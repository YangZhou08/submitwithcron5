...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_largeplussmalllora.py --experiment_setting setting0 --kernel_size 4 --model_name tinyllama --batch_size 24 --use_large_model --autoregressive_first_element --group1lr 5e-5 --usedatasettype c4 --num_epoch 5 --finetune_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/tinyllama_setting0_7_d694176_869805/checkpoint-3000/ --fullcoverage --path_d 0 --datafilegranularity 24 --gradient_accumulation_steps 16 --warmup_steps 1000 
