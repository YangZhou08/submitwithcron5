...
accelerate launch --main_process_port 29505 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --batch_size 128 --experiment_setting setting0 --ce_loss_only 
...
# accelerate launch --main_process_port 29506 --num_processes 8 --num_machines 1 largemodelfinetuning_mseplusceloss2.py --large_model tinyllama --kernel_size 7 --alpha 0.5 --ce_loss_only --experiment_setting setting0 --batch_size 128 --freeze_large_model --finetuned_large_model_checkpoint /fsx-storygen/beidic/yang/model_checkpoints/largemodeltinyllama_bf2f352_223990/checkpoint-3500 --lr 2e-4 
