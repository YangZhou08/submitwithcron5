...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 enlargingcontextlength.py --batch-size 32 --wandb llm160m --outputdir llama_160m_2k --datadir c4-1024+1024-Yarn-Llama-2-7b-128k --datalen 2048 
